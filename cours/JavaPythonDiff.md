...
| Condition `if` | `if condition {}` | `if condition:` | En Python, pas d'accolades : l'indentation définit le bloc de code. Elle est donc syntaxiquement obligatoire et doit être cohérente. |
