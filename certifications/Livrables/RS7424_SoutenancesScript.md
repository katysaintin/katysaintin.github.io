...
J'ai 25 ans d'expérience en contrôle-commande scientifique, dont 13 ans à SOLEIL et 9 ans au CEA. Je maîtrise les deux grands standards SCADA du domaine, EPICS et TANGO, et je suis cheffe de produit MUSCADE depuis 2025. Mon rôle est avant tout managérial : sortir d'une organisation où je suis la seule experte, et faire monter mon équipe en compétences. J'ai obtenu la certification RS6776 un mois avant celle-ci, avec 96 % à l'écrit, sur la culture IA, le prompt engineering et la création de contenu. Le RS7424 est un prolongement naturel : j'y ajoute la cartographie de processus, la reconfiguration d'équipe et le pilotage par indicateurs.
